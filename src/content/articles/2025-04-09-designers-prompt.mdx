...
description: Exploring how AI tools are changing the design landscape, and why learning to
  prompt effectively is becoming more important than learning to code for
  designers.
